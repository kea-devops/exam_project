...
def counterparty(account):
    return BANK_REG_NUM + ' ' + str(account.account_num)
...
account11 = Account(customer = customer1, account_type = Account_type.objects.get(name="Regular"), name = "Nemkonto", created_at = DateTimeField(auto_now_add=True), updated_at = DateTimeField(auto_now=True),)
account12 = Account(customer = customer1, account_type = Account_type.objects.get(name="Savings"),name = "Opsparingskonto",created_at = DateTimeField(auto_now_add=True),updated_at = DateTimeField(auto_now=True),)
account13 = Account(customer = customer1, account_type = Account_type.objects.get(name="Loan"),name = "Billån", created_at = DateTimeField(auto_now_add=True), updated_at = DateTimeField(auto_now=True),)
...
account21 = Account(customer = customer2, account_type = Account_type.objects.get(name="Regular"), name = "Nemkonto", created_at = DateTimeField(auto_now_add=True), updated_at = DateTimeField(auto_now=True))
account22 = Account(customer = customer2, account_type = Account_type.objects.get(name="Savings"), name = "Opsparingskonto", created_at = DateTimeField(auto_now_add=True), updated_at = DateTimeField(auto_now=True))
account23 = Account(customer = customer2, account_type = Account_type.objects.get(name="Loan"), name = "Billån", created_at = DateTimeField(auto_now_add=True), updated_at = DateTimeField(auto_now=True))
...
account31 = Account(customer = customer3, account_type = Account_type.objects.get(name="Regular"), name = "Nemkonto", created_at = DateTimeField(auto_now_add=True), updated_at = DateTimeField(auto_now=True))
account32 = Account(customer = customer3, account_type = Account_type.objects.get(name="Savings"), name = "Opsparingskonto", created_at = DateTimeField(auto_now_add=True), updated_at = DateTimeField(auto_now=True))
account33 = Account(customer = customer3, account_type = Account_type.objects.get(name="Loan"), name = "Billån", created_at = DateTimeField(auto_now_add=True), updated_at = DateTimeField(auto_now=True))
