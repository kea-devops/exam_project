...
from .views import customer_transaction_details
...
urlpatterns = [
    ...
    path('customers/<int:customer_id>/transactions/<uuid:transaction_id>/', customer_transaction_details, name='customer_transaction_details'),
]
